...
remote.getGlobal("sharedObject").backgroundColor = getComputedStyle(document.documentElement)
  ...
  .trim();
var titleColor = getComputedStyle(document.documentElement)
  .getPropertyValue("--title-color")
  .trim();
var titleBgColor = getComputedStyle(document.documentElement)
  .getPropertyValue("--title-background-color")
  .trim();
...
ipcRenderer.on("setTheme", function(event, theme) {
  ...
  titleColor = getComputedStyle(document.documentElement)
    .getPropertyValue("--title-color")
    .trim();
  titleBgColor = getComputedStyle(document.documentElement)
    .getPropertyValue("--title-background-color")
    .trim();
